...
Hope you enjoyed the first post. Please leave comments if you want. The full code for this blog post is available on [Github](https://github.com/BrandonHoeft/deepdishdata/tree/master/sept2018/cubs_division_odds).

``` {r}
# WORKS!!!
library(markdown)
#http://rstudio-pubs-static.s3.amazonaws.com/30704_583c8c8e2b254bf6a0791543d4a3438b.html
# to convert markdown to clean HTML for copy paste into blog.
markdownToHTML("who_is_winning_the_nl_central.md", "who_is_winning_the_nl_central.html",
               fragment.only=TRUE)
